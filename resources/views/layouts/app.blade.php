                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        @auth
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('fournisseurs.index') ? 'active' : '' }}" href="{{ route('fournisseurs.index') }}">Fournisseurs</a>
                            </li>
                        @endauth

                        @guest
                            <li class="nav-item">
                                <a class="nav-link {{ request()->routeIs('login.showing') ? 'active' : '' }}" href="{{ route('login.showing') }}">Se connecter</a> 
                            </li>
                            <li class="nav-item">
                        ...
                        @auth
                            <li class="nav-item">
                                <a class="nav-link btn btn-outline-danger btn-sm" href="{{ route('login.logout') }}" 
